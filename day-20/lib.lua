--- A better standered library V1.5
-- @module lib
...
function table.overlap(t1, t2, testKeys)
  out = {}
...
function string.countChar(str, c)
  local count = 0
  for i = 1, #str do
...
function string.seperate(str, seperator)
  local sep = {}
  local m = ""
  for i = 1, #str do
...
function io.read_data(f, seek, amount)
  local old = f:tell()
  f:seek(seek)
